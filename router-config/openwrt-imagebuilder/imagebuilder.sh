...
rebuild_firmware() {
    ...
    my_packages="\
        attr base-files bash bc blkid block-mount blockd bsdtar sudo irqbalance hwinfo  \
        btrfs-progs busybox bzip2 cgi-io chattr comgt comgt-ncm coremark kmod-batman-adv  \
        coreutils coreutils-base64 coreutils-nohup coreutils-truncate curl  \
        dosfstools dumpe2fs e2freefrag e2fsprogs exfat-mkfs cgroup-tools cgroupfs-mount libcgroup lxc-cgroup  \
        f2fs-tools f2fsck fdisk gawk getopt gzip hostapd-common iconv iw iwinfo jq jshn  \
        kmod-brcmfmac kmod-brcmutil kmod-cfg80211 kmod-mac80211 libjson-script kmod-fs-btrfs btrfs-progs  \
        liblucihttp liblucihttp-lua libnetwork losetup lsattr lsblk lscpu mkf2fs kmod-fs-ext4 libext2fs2  \
        ...
        kmod-fs-autofs4 uclient-fetch uhttpd uhttpd-mod-ubus unzip uqmi usb-modeswitch  \
        ...
        luci-lib-ip luci-lib-ipkg luci-lib-jsonc luci-lib-nixio luci-proto-batman-adv  \
        luci-mod-admin-full luci-mod-network luci-mod-status luci-mod-system  \
        luci-proto-bonding luci-proto-ipip luci-proto-ipv6 luci-proto-ncm  \
